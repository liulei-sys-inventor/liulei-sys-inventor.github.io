...
<p>刘磊的研究包括端/云计算系统、数据中心、操作系统（新一代AIOS）、量子计算系统、内存系统（NVM、大内存架构）等。自2011年起，刘磊带领实验室（Sys-Inventor Lab）研发了面向多核/多通道高效能计算机服务器的一系列关键技术，包括内存架构、异构内存体系、内存管理与优化的系列方法与机制；探索了OS的智能化，研发了面向端/云设备的智能化OS内核；探索了量子计算机体系结构，研发了面向“量-超-智”计算融合的软硬件系统（如量子OS、软件栈、硬件加速器等）。研究成果以第一作者/通讯作者发表于ISCA, HPCA, FAST, PACT, IEEE TC, TPDS, ACM TACO等领域内权威学术会议和刊物，在业内产生了影响力。近十年，刘磊曾主持或参与多项国家级项目（包括自然科学基金、重点研发计划、省重点研发等项目、课题）。此外，他还担任了一系列权威国际学术会议的程序委员会委员、组委会成员等职位50余次（2次担任ACM/IEEE权威学术会议的总主席，并担任A类期刊副主编等），是中国计算机学会量子计算专委会首批执行委员会委员。刘磊曾以第一完成人获得“中国计算机学会技术发明奖、科技进步奖”、获得“北航优秀科研人员”、“中国科学院院长优秀奖”、“计算所优秀科研人员” 等荣誉。</p>
