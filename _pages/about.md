...
## PI Brief Biography<span id="biography"></span>

Lei Liu is a Full Professor (PI) of Computer Science at Beihang University (2022 - Now) and was a professor at ICT, CAS. He leads the Sys-Inventor Lab (2011 - Now), an independent lab within ICT's SKLCA from 2011 to 2021, and in CS at Beihang from 2022 to present. Lei Liu served as the Chief Engineer of the National Supercomputing Center (Shenzhen). He joined the ICT faculty in 2014 after receiving his Ph.D. degree from ICT (his [Ph.D. thesis](/files/phd_thesis.pdf)). Besides, he received his MS degree in software system design from the University of Science and Technology of China (USTC) and his BS degree in computer science from Dalian University of Technology (DLUT). He spent several years in industry as a software engineer and senior software architect. He was a visiting scholar in CS at the University of Rochester (UR).

Dr. Liu is an autonomous system researcher who has built his academic reputation through ground-up innovations and rigorous engineering. He has led research projects that have advanced the cloud native technologies, datacenters, and next-generation computer systems, including -  1) Technical  evolutions for memory partitioning approaches; 2) Hybrid memory systems; 3) AIOS and Intelligent OS; 4) Quantum computing systems. As the leading author (PI), Lei has published research articles in venues including ISCA, HPCA, FAST, PACT, IEEE TC, TPDS, ACM TACO, etc.
...
<p>刘磊，男，1981年9月出生于新疆乌鲁木齐市，祖籍辽宁沈阳，现任北京航空航天大学教授，博士研究生导师，计算机学院系统结构研究所书记，实验室主任（PI）；曾是中科院计算所国重副研究员（PI），研究生导师；兼任国家超算中心（深圳）总工程师（中组部挂职，2020/11/01-2021/11/30）。刘磊分别于大连理工大学、中国科学技术大学、中国科学院大学（中科院计算所）获得计算机科学与技术工学学士学位（导师：牛纪桢）、软件系统设计工程硕士学位（导师：赵振西）和计算机体系结构工学博士学位（<a href="/files/phd_thesis.pdf">博士论文链接</a>），并于2014年留计算所工作。刘磊于2017年5月～2018年4月在美国罗彻斯特大学计算机科学系交流访问。</p>
<p>刘磊的研究包括端/云计算系统、数据中心、操作系统（新一代AIOS）、量子计算系统、内存系统（NVM、大内存架构）等。自2011年起，刘磊带领其实验室（Sys-Inventor Lab）研发了面向多核、多通道服务器的内存架构、异构内存体系，及内存系统管理与优化的一系列方法与机制；探索了OS的智能化，研发了面向端/云设备的智能化OS内核；探索了量子计算机体系结构，研发了面向“量-超-智”计算融合的软硬件系统（如量子OS、软件栈、硬件加速器等）。研究成果以第一作者/通讯作者发表于ISCA, HPCA, FAST, PACT, IEEE TC, TPDS, ACM TACO等领域内权威学术会议和刊物，在业内产生了影响力。近十年，刘磊曾主持或参与多项国家级项目（包括自然科学基金、重点研发计划、省重点研发等项目、课题）。此外，他还担任了一系列权威国际学术会议的程序委员会委员、组委会成员等职位50余次（2次担任ACM/IEEE权威学术会议的总主席，并担任A类期刊副主编等），是中国计算机学会量子计算专委会首批执行委员会委员。刘磊曾以第一完成人获得“中国计算机学会技术发明奖、科技进步奖”、获得“北航优秀科研人员”、“中国科学院院长优秀奖”、“计算所优秀科研人员” 等荣誉。</p>
...
6. [**Hierarchically Optimizting Data Placement across Cache and Memory Banks on Cloud Servers (2011~Now)**](https://arxiv.org/pdf/1704.01198.pdf)
   ...
   - Lei has led this project since 2011 (PI). This project has a continuous impact on both academia and industry. The history and development of this series of studies can be accessed via this [**link**](http://www.jos.org.cn/jos/article/abstract/6370) for Chinese version and [**here**](https://arxiv.org/pdf/1704.01198.pdf).

7. **Reducing Memory Conflicts on Real Cloud Servers - DRAM Bank/Channel Partitioning Mechanism (BPM/BPM+) (2011~Now)**

   This work begins with the contention/interference issues in main memory systems, and this study tackles them from the OS angle. In existing OS, memory resources are “blindly” allocated to applications (threads), leading to memory contentions in DRAM Banks at the root. To solve this problem, Lei extends the well-known **Page-Coloring** to eliminate or mitigate interference between threads on memory banks and channels. These studies have helped motivate many works aimed at improving overall system throughput, locality, and QoS. More details are in **<span style="color:#953734;">PACT-2012 and ACM TACO-2014</span>**. Lei has led this project as PI since 2011. This project has a continuous impact on both academia and industry.
...
8. <span style="white-space: nowrap">[iSwap: A New Memory Page Swap Mechanism for Reducing Ineffective I/O Operations in Cloud Environments](https://dl.acm.org/doi/pdf/10.1145/3653302) [[**<span style="color:#953734;">Slides (pptx) in Chinese</span>**](/files/iSwap.pptx)] [<a href="javascript:void(0);" onclick="openVideoModal('/files/iswap_video.mp4');" style = "color: #953734; font-weight: bold;">Demo Video</a>]</span>

   Zhuohao Wang, **Lei Liu\***, Limin Xiao. ACM Transactions on Architecture and Code Optimization **(TACO)**:2024

9. <span style="white-space: nowrap">[QuCloud+: A Holistic Qubit Mapping Scheme for Single/Multi-programming on 2D/3D NISQ Quantum Computers](https://dl.acm.org/doi/pdf/10.1145/3631525)</span>

   **Lei Liu\***, Xinglei Dou. ACM Transactions on Architecture and Code Optimization **(TACO)**:2024

10. <span style="white-space: nowrap">[Intelligent Resource Scheduling for Co-located Latency-critical Services: A Multi-Model Collaborative Learning Approach](https://www.usenix.org/system/files/fast23-liu.pdf) [[**<span style="color:#953734;">Slides (pptx)</span>**](/files/fast23_slides_liu.pptx)] [<a href="javascript:void(0);" onclick="openVideoModal('/files/osml_video.mp4');" style = "color: #953734; font-weight: bold;">Demo Video</a>]</span>

    **Lei Liu\***, Xinglei Dou, Yuetao Chen. The 21st USENIX Conference on File and Storage Technologies **(FAST)**:2023

11. ATA-Cache: Contention Mitigation for GPU Shared L1 Cache with Aggregated Tag Array

    X. Xu, L. Wang, L. Xiao, **L. Liu**, et al. IEEE Trans. on Computer-Aided Design of Integrated Circuits and Systems **(TCAD)**:2023  

12. [EBIO: An Efficient Block I/O Stack for NVMe SSDs with Mixed Workloads](https://ieeexplore.ieee.org/document/10186069)

    J. Zhu, L. Wang, L. Xiao, **L. Liu**, G. Qin. IEEE Trans. on Computer-Aided Design of Integrated Circuits and Systems **(TCAD)**:2023

13. [CFIO: A conflict-free I/O mechanism to fully exploit internal parallelism for Open-Channel SSDs](https://www.sciencedirect.com/science/article/abs/pii/S1383762122002880)

    J. Zhu, L. Wang, L. Xiao, **L. Liu**, G. Qin. Journal of Systems Architecture **(JSA)**:2023

14. [Smart Scheduler: an Adaptive NVM-Aware Thread Scheduling Approach on NUMA Systems](https://rdcu.be/cXmO6)

    Y. Chen, K. Qiu, L. Chen, H. Jia, Y. Zhang, L. Xiao, **L. Liu\***. CCF Trans. on High Performance Computing **(THPC)**:2022

15. <span style="white-space: nowrap">[QuCloud: A New Qubit Mapping Mechanism for Multi-programming Quantum Computing in Cloud Environment](/files/QuCloud_HPCA_2021_ready.pdf) [[**<span style="color:#953734;">Slides (pptx)</span>**](/files/QuCloud.pptx)]</span>
    ...
    **Lei Liu\***, Xinglei Dou. The 27th IEEE International Symposium on High-Performance Computer Architecture **(HPCA)**:2021   
    ...
    <div style="margin: 0; padding: 0; line-height: 1.1;">
        ...
        <div style="color:#ca6a20;">
            <strong><em>- This is the first work about quantum computer architecture published in top venues from organizations in Asian</em></strong>
        </div>
    </div>

16. [The Evolution of Memory Partitioning Technologies: A Case Study through Page Coloring](/files/JS2021.pdf)

    Jiefan Qiu, Zonghan Hua, Jing Fan, **Lei Liu\***. Journal of Software in Chinese **(软件学报)**:2021

17. [An Investigation into Quantum Program Mapping on Superconducting Quantum Computers](/files/JCRD-2021.pdf)
...
18. [Quantum Computing Simulations and Optimizations: A Survey](/files/CE-2021.pdf)
...
19. <span style="white-space: nowrap">[IEEE Proceedings of the IEEE International Symposium on Workload Characterization, Virtual. October 27-29, 2020](https://ieeexplore.ieee.org/xpl/conhome/9251098/proceeding)</span>

    **General Chair**. IEEE 16th International Symposium on Workload Characterization  **(IISWC)**:2020   

20. A New Qubits Mapping Mechanism for Multi-programming Quantum Computing [[**<span style="color:#953734;">Slides (pptx)</span>**](/files/quantum_talk.pptx)]
...
21. [Monitoring Memory Behaviors and Mitigating NUMA Drawbacks on Tiered NVM Systems](/files/NPC2020.pdf) [[**<span style="color:#953734;">Slides (pptx)</span>**](/files/NVM.pptx)]
...
24. Efficient GPU NVRAM Persistence with Helper Warps

    Sui Chen, Faen Zhang, **Lei Liu** and Lu Peng. The 56th ACM/IEEE/SIGDA/CEDA Design Automation Conference **(DAC)**:2019

25. [Thinking about A New Mechanism for Huge Page Management](/files/apsys-2019-final.pdf)  [[**<span style="color:#953734;">Slides (pptx)</span>**](/files/apsys-2019.pptx)]

    X. Li, **L. Liu\***, S. Yang, L. Peng, J. Qiu. The 10th ACM SIGOPS Asia-Pacific Workshop on Systems **(APSys)**:2019

26. <span style="white-space: nowrap">[ACM Proceedings of the 2018 International Conference on Supercomputing, Beijing, China. June 12-15, 2018](https://portalparts.acm.org/3210000/3205289/fm/frontmatter.pdf?ip=159.226.43.53)</span>

    **General Chair**. ACM 32nd International Conference on Supercomputing **(ICS)**:2018

27. [Tackling Diversity and Heterogeneity by Vertical Memory Management](/files/vp.pdf) 

    **Lei Liu**.[ arXiv:1704.01198](https://arxiv.org/abs/1704.01198):2017 **(Short Version for the ISCA-2014 Paper)**

28. [Memos: Revisiting Hybrid Memory Management in Modern Operating System](https://pan.cstcloud.cn/s/NV5GdcN3T3A)

    **Lei Liu\***, Mengyao Xie and Hao Yang.[ arXiv:1703.07725](https://arxiv.org/abs/1703.07725):2017

29. [SysMon: Monitoring Memory Behaviors via OS Approach](/files/appt2017-sysmon-myx.pdf)

    M. Xie, **L. Liu\***, H. Yang, et al. The 12th Intl. Symp. on Adv. Par. Processing Tech. **(APPT)**:2017

30. [Memos: A Full Hierarchy Hybrid Memory Management Framework](/files/ICCD_8.pdf) (Position Paper)

    **Lei Liu\***, et al. The 34th International Conf. on Computer Design **(ICCD)**:2016

31. [Rethinking Memory Management in Modern Operating System: Horizontal, Vertical or Random?](/files/tc-2015-pass19.pdf)  [[**<span style="color:#953734;">Slides (pptx)</span>**](/files/All in TC.pptx)] 
...
32. [Going Vertical in Memory Management: Handling Multiplicity by Multi-policy](/files/ISCA2014_FINAL_pass2.pdf)  [**[<span style="color:#953734;">Slides (pptx)</span>](/files/ISCA2014.pptx)**] 
...
33. [BPM/BPM+: Software-based Dynamic Memory Partitioning Mechanisms for Mitigating DRAM Bank-/Channel-level Interferences in Multicore Systems](/files/taco_pass24.pdf)

    **Lei Liu\***, et al. ACM Transactions on Architecture and Code Optimization **(TACO)**:2014 

34. [A Software Memory Partition Approach for Eliminating Bank-level Interference in Multicore Systems](/files/pact140-liu-final.pdf)  [[**<span style="color:#953734;">Slides (pptx)</span>**](/files/pact-liu-presentation.pptx)]
...
36. Dynamic I/O-Aware Scheduling for Batch-Mode Applications on Chip Multiprocessor Systems of Cluster Platforms
...
1. 一种面向资源受限端侧设备的大模型演化机制 (Chinese Version). **First Inventor**

2. 一种量子操作系统中任务抽象与任务管理的机制 (Chinese Version). **First Inventor**

3. 一种面向分布式多量子设备的资源管理机制 (Chinese Version). **First Inventor**

4. 一种基于强化学习的移动设备算力调度方法 (Chinese Version). **First Inventor** 

5. 一种为延迟敏感应用分配大页并缓解内存膨胀的页面分配机制 (Chinese Version). **First Inventor**

6. 一种面向分布式量子计算环境的量子线路半切割机制 (Chinese Version). **First Inventor**

7. 一种面向分布式量子计算的量子程序映射机制 (Chinese Version). **First Inventor**

8. 一种减少延迟敏感应用页面迁移的内存分配机制 (Chinese Version). **First Inventor**

9. 一种基于机器学习的移动设备算力调度方法 (Chinese Version). **First Inventor** 

10. 一种减少延迟敏感应用程序的内存页面 IO 操作的操作系统内存换页机制 (Chinese Version). **First Inventor**

11. 一种减少无效 I/O 的操作系统内存换页机制 (Chinese Version). **First Inventor**

12. 面向超导量子计算机的量子程序并行处理方法及操作系统 (Chinese Version). **First Inventor** 

13. 一种微服务资源调度系统和方法 (Chinese Version). **First Inventor** 

14. 一种消除远程非易失性内存访问的进程调度技术 (Chinese Version). **First Inventor**

15. [Memory Resource Optimization Method and Apparatus (PCT, US).](https://patents.google.com/patent/US9857980B2/en) **First Inventor (with Wu and Feng)**. 

16. 一种存储器资源优化方法和装置 (Chinese Version). **First Inventor (with Wu and Feng). 发明人：刘磊、吴、冯晓兵**.
...
3. [“东数西算”半载，行业突围战打响，人才、网络、节能等成关键](https://www.163.com/dy/article/HEO2A0F705199NPP.html)（Invited Interview in Chinese）

4. [“东数西算”解决算力分布式使用面临的挑战是数据移动的开销](http://k.sina.com.cn/article_3740356007_def14da702002tde6.html)（Invited Interview in Chinese）
...
10. [PACT-2015 PC会议记录与硅谷工业界访问之行](/files/PACT-2015 PC副本.pdf)（Invited Essay in Chinese）

11. [ISCA-2014与北美学术之旅](/files/ISCA-2014与北美学术之旅.pdf)（Invited Essay in Chinese）

12. [Page Coloring的历史与发展](/files/Page Coloring的历史与发展.pdf)（Invited Survey in Chinese）
...
7. Member of the Program Committee of HPCA-2027, 2026 (for both industry and academic track), 2020, 2019 (ERC)
...
- Yong Li, 2014, intern, first job - engineer in VMware; supervised since 2013 to 2015 and A. K. Jones (PITT)
- Zehan Cui, 2015, intern, first job - ICT till 2016; supervised since 2011 to 2012
...
<div id="videoModal" style="display:none; position:fixed; z-index:1000; left:0; bottom:0; width:100vw; height:100vh; background-color:rgba(0,0,0,0.8); align-items:center; justify-content:center; ">
  <div style="width:80%; max-width:80vw; text-align:center;">
...
<div id="imageModal" style="display:none; position:fixed; z-index:1001; left:0; right:0; top: 0; bottom:0; width:100vw; height:100vh; background-color:rgba(0,0,0,0.8); align-items:center; justify-content:center; cursor:pointer;">
  <div style="width:80%; max-width:80vw; max-height:80vh; text-align:center; display:flex; align-items:center; justify-content:center;">
    <img id="fullscreenImage" style="max-width:100%; max-height:80vh; object-fit:contain; margin:0 auto;" src="/images/calligraphy_1.jpg">
  </div>
</div>
