...
<p>刘磊的研究包括高效能计算机系统、量子计算系统、智能操作系统、端/云计算系统、数据中心、内存系统（NVM、大内存架构）等。自2011年起，刘磊带领实验室（Sys-Inventor Lab）研发了面向多核/多通道高效能计算机服务器的一系列关键技术，包括内存架构、异构内存体系、内存管理与优化的系列方法与机制；探索了OS的智能化，研发了面向端/云设备的智能化OS内核；探索了量子计算机体系结构，研发了面向“量-超-智”计算融合的软硬件系统（如量子OS、软件栈、硬件加速器等）。研究成果以第一作者/通讯作者发表于ISCA, HPCA, FAST, PACT, IEEE TC, TPDS, ACM TACO等领域内权威学术会议和刊物，在业内产生了影响力。近十年，刘磊曾主持或参与多项国家级项目（包括自然科学基金、重点研发计划、省重点研发等项目、课题）。此外，他还担任了一系列权威国际学术会议的程序委员会委员、组委会成员等职位50余次（2次担任ACM/IEEE权威学术会议的总主席，并担任A类期刊副主编等），是中国计算机学会量子计算专委会首批执行委员会委员。刘磊曾以第一完成人获得“中国计算机学会技术发明奖、科技进步奖”、获得“北航优秀科研人员”、“中国科学院院长优秀奖”、“计算所优秀科研人员” 等荣誉。</p>
...
2. **Quantum Computing OS and Architecture**
   ...
   (2) The quantum computer architecture, hardware/software stack
...
8. 一种面向分布式量子计算的量子程序映射机制 (Chinese Version). **First Inventor**

9. 一种减少延迟敏感应用页面迁移的内存分配机制 (Chinese Version). **First Inventor**

10. 一种基于机器学习的移动设备算力调度方法 (Chinese Version). **First Inventor** 

11. 一种减少延迟敏感应用程序的内存页面 IO 操作的操作系统内存换页机制 (Chinese Version). **First Inventor**

12. 一种减少无效 I/O 的操作系统内存换页机制 (Chinese Version). **First Inventor**

13. 面向超导量子计算机的量子程序并行处理方法及操作系统 (Chinese Version). **First Inventor** 

14. 一种微服务资源调度系统和方法 (Chinese Version). **First Inventor** 

15. 一种消除远程非易失性内存访问的进程调度技术 (Chinese Version). **First Inventor**

16. [Memory Resource Optimization Method and Apparatus (PCT, US).](https://patents.google.com/patent/US9857980B2/en) **First Inventor (with Wu and Feng)**. 

17. 一种存储器资源优化方法和装置 (Chinese Version). **First Inventor (with Wu and Feng). 发明人：刘磊、吴、冯晓兵**.
